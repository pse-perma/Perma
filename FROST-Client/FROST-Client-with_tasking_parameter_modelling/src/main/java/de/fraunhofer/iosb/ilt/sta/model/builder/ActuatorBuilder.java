...
public class ActuatorBuilder extends AbstractActuatorBuilder<ActuatorBuilder> {
    ...
    public void withTaskingCapability(EntityList<TaskingCapability> taskingCapability) {
        actuator.setCapabilities(taskingCapability);
    }
    ...
    public Actuator build() {
        ...
        newActuator.setId(actuator.getId());
        return newActuator;
    }
}
